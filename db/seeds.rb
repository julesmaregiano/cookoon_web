...
cookoons_attributes = [
  {user: User.first, name: "Penthouse", surface: 200, price_cents: 20000, price_currency: "EUR", address: "16 Villa Gaudelet, 75011 Paris", capacity: "150", category: 'Maison'},
  {user: User.first, name: "Veranda", surface: 120, price_cents: 10000, price_currency: "EUR", address: "1 rue Eugène Eichenberger, 92800 Puteaux", capacity: "10", category: 'TOIT'},
  {user: User.last, name: "Bureaux", surface: 300, price_cents: 15000, price_currency: "EUR", address: "12 rue Lincoln - 75008 Paris", capacity: "80", category: 'Appartement'}
  {user: User.last, name: "Appartement Cosy", surface: 90, price_cents: 7000, price_currency: "EUR", address: "51 rue Ligier, 33000 Bordeaux", capacity: "12", category: 'Appartement'}
]
